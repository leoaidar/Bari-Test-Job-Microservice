...
{
    public class MessageCacheRepository_Old : IRepository<Message>
    {
        private RedisCacheContext _ctx;

        public MessageCacheRepository_Old(RedisCacheContext ctx) : base()
        {
            _ctx = ctx;
        }

        public MessageCacheRepository_Old()
        {
        }
